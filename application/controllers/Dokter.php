...
class Dokter extends CI_Controller {
    ...
    function __construct(){
        ...
        $this->load->model('m_dokter');//model yang di panggil
    ...
    function edit($id){
        ...
        $where = array('id_dokter' => $id); //'id' merupakan id dari tabel
        $data['r'] = $this->m_dokter->edit_data($where)->row_array(); //r=users
