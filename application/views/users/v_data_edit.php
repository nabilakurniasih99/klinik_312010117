    ...
    <div class="container-fluid">
        <div class="card border-primary">
            <div class="card-header bg-primary text-white">
                ...
                <a href="<?= base_url('users'); ?>" class="btn btn-warning btn-sm float-end">Kembali</a>
            </div>
            <div class="card-body">
                <form method="post" action="<?= base_url('users/update'); ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="password" name="password" value="<?= $r['password'];?>" class="form-control" placeholder="Kosongkan jika tdk merubah password.">
                    </div>
